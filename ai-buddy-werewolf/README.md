...
```bash
npm test        # vitest (役職配布/秘密分離/初日焦点型2幕討論と指名回答/親密度補正・勾配集計/初日占い/襲撃統合/勝敗/リプレイ復元/公開Lab復元/愛言葉正規化/引継ぎ整合性/モック完走 など65件)
...
2. **ゲーム画面**: 初日は抽選された2人の弁明と残り全員の評価を読み、その後に1日1回の相談(疑い/質問/確定情報共有/スキル対象/立ち回り)を送る。相談後の応答討論を見てから、裁判で処刑したい相手を選ぶ(最終投票はバディが決める)。狼なら夜に襲撃提案
