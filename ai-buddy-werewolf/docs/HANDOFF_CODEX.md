...
- 自動テスト124件（5役職・役職を名乗る相談/公開宣言/試合後真偽・初日焦点2人の弁明・討論3段階・相談中の時計停止/再開・15秒/5発言でも主人相談とresponseを保証・同時生成中の無関係発言を名指しへの返答と誤認しない回帰・指名質問の回答・時間切れ終了・Play Testの内部リプレイ境界・公開Labのブラウザ内完走/復元・旧試合の凍結助言・旧v1引継ぎ互換・日本語を含む愛言葉正規化・複数の占い・護衛・霊媒・初日占い・秘密分離を含む）/ ESLint / strict TypeScript
