...
```bash
npm test        # vitest (5役職/秘密分離/役職を名乗る相談/討論3段階・複数相談・相談後の見解更新・同義質問防止・発言60文字上限・名指し応答・Live評価候補制限/親密度補正/複数の占い・護衛・霊媒/初日占い/襲撃統合/勝敗/リプレイ境界/公開Lab復元/Live AI・9組の初期選択/旧試合・引継ぎ互換/モック完走 など154件)
