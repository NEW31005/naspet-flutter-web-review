...
『AIバディ人狼』(人間主人 + AIバディの二人一組人狼)の**ゲームの核が面白いかを検証するPhase0実験用WEBアプリ**。完成品ではない。仮ルールを置き、設定・プロンプトを素早く差し替えて再試験できることを最優先している。ゲームの核4原則(主人だけが持つ情報 / 選択式の少数回助言 / 最終投票はAI / 内部スコア試合中非公開)は削ってはならない。詳細: [GAME_OVERVIEW.md](GAME_OVERVIEW.md)
...
- 助言6種(主観疑い/質問指定/確定情報共有/スキル対象提案/役職を名乗る相談/立ち回り)。本格9組は1日2回、時間制は最大3回
...
- [ ] 助言がプリセットの上限内・選択式で、裁判中の確定情報共有不可が維持されている
